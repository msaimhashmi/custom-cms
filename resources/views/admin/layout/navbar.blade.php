  ...
  <div class="navbar navbar-toggleable-sm flex-row align-items-center">
    ...
    <div class="collapse navbar-collapse" id="collapse">
      ...
      <ul class="nav navbar-nav mr-auto">
        <li class="nav-item dropdown">
          ...
          <div ui-include="'/admin/views/blocks/dropdown.new.html'"></div>
        </li>
      </ul>
      
      <div ui-include="'/admin/views/blocks/navbar.form.html'"></div>
      <!-- / -->
    </div>
    <!-- / navbar collapse -->
    ...
    <ul class="nav navbar-nav ml-auto flex-row">
      <li class="nav-item dropdown pos-stc-xs">
        ...
        <div ui-include="'/admin/views/blocks/dropdown.notification.html'"></div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link p-0 clear" href="#" data-toggle="dropdown">
          <span class="avatar w-32">
            <img src="/admin/assets/images/a0.jpg" alt="...">
