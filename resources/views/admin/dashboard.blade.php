      ...
      <div class="box">
        ...
        <ul class="list no-border p-b">
          <li class="list-item">
            <a herf class="list-left">
              <span class="w-40 avatar">
                <img src="/admin/assets/images/a4.jpg" alt="...">
          ...
          <li class="list-item">
            <a herf class="list-left">
              <span class="w-40 avatar">
                <img src="/admin/assets/images/a5.jpg" alt="...">
                <i class="on b-white bottom"></i>
              </span>
            </a>
            <div class="list-body">
          ...
          <li class="list-item">
            <a herf class="list-left">
              <span class="w-40 avatar">
                <img src="/admin/assets/images/a6.jpg" alt="...">
          ...
          <li class="list-item">
            <a herf class="list-left">
              <span class="w-40 avatar">
                <img src="/admin/assets/images/a7.jpg" alt="...">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <div class="streamline b-l m-b m-l">
            <div class="sl-item">
              <div class="sl-left">
                <img src="/admin/assets/images/a2.jpg" class="img-circle">
              </div>
              <div class="sl-content">
            ...
            <div class="sl-item">
              <div class="sl-left">
                <img src="/admin/assets/images/a5.jpg" class="img-circle">
              </div>
              <div class="sl-content">
            ...
            <div class="sl-item">
              <div class="sl-left">
                <img src="/admin/assets/images/a8.jpg" class="img-circle">
              </div>
              <div class="sl-content">
